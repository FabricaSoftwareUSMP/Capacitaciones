...
public class Producto extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(accion.equals("agregar")){
			...
			try {
				...
				HamburguesaDao hamburguesadao = dao.getHamburguesaDao();
				Vector<HamburguesaBean> hamburguesas = hamburguesadao.seleccionarTodos();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			producto.setHambuerguesa_id( Integer.parseInt(request.getParameter("sel_hamburguesa")) );
			...
			producto.setCrema_id( Integer.parseInt(request.getParameter("cbo_cremas")) );
